...
**Native Windows** is not a grain host; use the remote CLI/SDK against a Linux or macOS machine if needed ([remote host guide](https://grainvm.com/docs/main/guides/remote-host/)). **WSL** reports as Linux and uses the same virt requirements as other Linux hosts.
...
Troubleshooting: [guides/troubleshooting](https://grainvm.com/docs/main/guides/troubleshooting/). Security model: [explain/security](https://grainvm.com/docs/main/explain/security/).

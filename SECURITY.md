...
- Full team-box setup: **[Remote sandbox host](https://grainvm.com/guides/remote-host/)** (`docs/guides/remote-host.md`). Happy path: **[Remote lab](https://grainvm.com/guides/remote-lab/)**.

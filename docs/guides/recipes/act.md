...
- **Secrets:** do not bake CI secrets into the image. Prefer act’s secret flags, or [grain proxy](/guides/proxy/) for HTTP APIs.  
...
- [Docker socket recipe](/guides/recipes/docker-socket/)  
- [CI ephemeral recipe](/guides/recipes/ci-ephemeral/)  

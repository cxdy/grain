...
Deep dives live elsewhere: [Install](/docs/0.2.2/get-started/install/) · [First sandbox tutorial + demo](/docs/0.2.2/get-started/first-sandbox/) · [Config reference](/docs/0.2.2/reference/config/).
...
Other install paths (release binary, `go install`, from source): [Install grain](/docs/0.2.2/get-started/install/).
...
All fields: [Configuration reference](/docs/0.2.2/reference/config/). Remote / team hosts need a token and different bind rules — see [Remote sandbox host](/docs/0.2.2/guides/remote-host/).
...
Docker + [act](https://github.com/nektos/act) run **inside** the guest so host Docker stays clean. Full guide: [GitHub Actions with act](/docs/0.2.2/guides/recipes/act/).
...
Pull kubeconfig and use host `kubectl` — see [k3s recipe](/docs/0.2.2/guides/recipes/k3s/).
...
More: [Profiles & presets](/docs/0.2.2/guides/profiles/) · [Mounts](/docs/0.2.2/guides/mounts/) · [Networking](/docs/0.2.2/guides/networking/).
...
| Create hangs / no shell | Prefer `grain-ubuntu`; see [Troubleshooting](/docs/0.2.2/guides/troubleshooting/) |
...
| SDK | Install |
|-----|---------|
| [Go](/docs/0.2.2/reference/go-sdk/) | `go get github.com/cxdy/grain/client` |
| [TypeScript](/docs/0.2.2/reference/typescript-sdk/) | `npm install @cxdy/grain` |
| [Python](/docs/0.2.2/reference/python-sdk/) | `pip install grainvm` |

---

## Next steps

- [GitHub Actions (act)](/docs/0.2.2/guides/recipes/act/) · [k3s lab](/docs/0.2.2/guides/recipes/k3s/)  
- [Your first sandbox](/docs/0.2.2/get-started/first-sandbox/) — interactive demo + deeper walkthrough  
- [Core concepts](/docs/0.2.2/get-started/concepts/) — daemon, images, agent, ephemeral vs persistent  
- [Guides](/docs/0.2.2/guides/) — images, agent, mounts, proxy, remote host  
- [CLI reference](/docs/0.2.2/reference/cli/) · [HTTP API](/docs/0.2.2/reference/api/)  

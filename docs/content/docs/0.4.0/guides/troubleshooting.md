...
Use `-P 8080:80` or `-P 80` (auto high host port). See [Networking](/docs/0.4.0/guides/networking/).

## Related

- [Networking](/docs/0.4.0/guides/networking/)
- [Mounts](/docs/0.4.0/guides/mounts/)

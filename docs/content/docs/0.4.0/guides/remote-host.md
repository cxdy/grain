...
If you need true multi-tenant SaaS isolation, put grain behind stronger controls (or separate hosts per trust domain). See [Security model](/docs/0.4.0/explain/security/).
...
- [Configuration](/docs/0.4.0/reference/config/) — `api`, `api_url`, `api_token`, caps  
- [Security model](/docs/0.4.0/explain/security/)  
- [CLI reference](/docs/0.4.0/reference/cli/)  
- [Go](/docs/0.4.0/reference/go-sdk/) · [TypeScript](/docs/0.4.0/reference/typescript-sdk/) · [Python](/docs/0.4.0/reference/python-sdk/) SDKs  

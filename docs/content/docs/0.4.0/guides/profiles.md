...
For long custom first-boot work that should block create until *you* say ready, implement the [Readiness protocol](/docs/0.4.0/explain/readiness/) and use `grain new --wait bootstrap`.
...
See the [act recipe](/docs/0.4.0/guides/recipes/act/).

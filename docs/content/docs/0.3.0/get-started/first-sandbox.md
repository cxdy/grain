...
For the shortest path (install + starter config + cleanup), use [Quick start](/docs/0.3.0/get-started/quickstart/).
...
**Next:** [Quick start](/docs/0.3.0/get-started/quickstart/) (config + common flags), [Core concepts](/docs/0.3.0/get-started/concepts/), then a [guide](/docs/0.3.0/guides/) for mounts, proxy, or k3s.

...
- **Secrets:** do not bake CI secrets into the image. Prefer act’s secret flags, or [grain proxy](/docs/0.3.0/guides/proxy/) for HTTP APIs.  
...
- [Docker socket recipe](/docs/0.3.0/guides/recipes/docker-socket/)  
- [CI ephemeral recipe](/docs/0.3.0/guides/recipes/ci-ephemeral/)  
- [Guest agent](/docs/0.3.0/guides/agent/)  

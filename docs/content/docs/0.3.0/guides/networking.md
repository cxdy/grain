...
secret injection. Details: [proxy.md](/docs/0.3.0/guides/proxy/).

## Related

- [Mounts](/docs/0.3.0/guides/mounts/) — share host directories into the guest
- [Egress proxy](/docs/0.3.0/guides/proxy/) — allowlist + secret injection
- [Troubleshooting](/docs/0.3.0/guides/troubleshooting/) — SSH wait, serial logs, resource caps

...
See [recipes/coding-agent.md](/docs/0.3.0/guides/recipes/coding-agent/) for a sandbox with a
...
- [Networking](/docs/0.3.0/guides/networking/) — SLIRP, hostfwd, ports
- [Recipes: coding agent](/docs/0.3.0/guides/recipes/coding-agent/)

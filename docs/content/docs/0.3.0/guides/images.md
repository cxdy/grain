...
Firecracker does not use UEFI the same way as QEMU aarch64 cloud boots. Prefer a FC-oriented kernel + rootfs pair. See [firecracker.md](/docs/0.3.0/guides/firecracker/) for layout, vsock agent, and limits.

## Related

- [Troubleshooting](/docs/0.3.0/guides/troubleshooting/) — pull failures, doctor image check
- [Firecracker](/docs/0.3.0/guides/firecracker/) — experimental FC backend, kernel/rootfs, vsock
- [Agent](/docs/0.3.0/guides/agent/) — wait modes, deploy, golden HasAgent path
- [Mounts](/docs/0.3.0/guides/mounts/) — 9p shares into the guest

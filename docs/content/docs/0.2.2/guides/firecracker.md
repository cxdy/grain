...
See also [images.md](/docs/0.2.2/guides/images/) for QEMU/golden workflow; FC is a separate experimental path.
...
- [images.md](/docs/0.2.2/guides/images/) — base images, golden bake (QEMU-oriented)
- [networking.md](/docs/0.2.2/guides/networking/) — QEMU SLIRP / hostfwd (not used by FC yet)
- [agent.md](/docs/0.2.2/guides/agent/) — guest agent HTTP API
- [troubleshooting.md](/docs/0.2.2/guides/troubleshooting/) — doctor and logs

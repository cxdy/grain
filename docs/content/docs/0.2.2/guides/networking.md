...
secret injection. Details: [proxy.md](/docs/0.2.2/guides/proxy/).

## Related

- [Mounts](/docs/0.2.2/guides/mounts/) — share host directories into the guest
- [Egress proxy](/docs/0.2.2/guides/proxy/) — allowlist + secret injection
- [Troubleshooting](/docs/0.2.2/guides/troubleshooting/) — SSH wait, serial logs, resource caps
